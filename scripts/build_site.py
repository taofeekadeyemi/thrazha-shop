...
def main():
    ...
    page_title = "Thrazha Bazaar | Open-Box, Overstock &amp; New Deals"
    page_description = "Name-brand overstock and inspected open-box goods at outlet prices."
...
<section class="hero">
  <div class="hero-inner">
    <div class="hero-copy">
      ...
      <p class="hero-body">Name-brand overstock and inspected open-box goods —
...
<footer class="site-footer">
  <div class="footer-grid">
    <div class="footer-brand">
      ...
      <p class="footer-tag">Overstock, open-box and auction finds. Shipping Canada-wide.</p>
    </div>
    ...
    <div class="footer-col" id="get-in-touch">
      ...
      <a href="returns.html">Holds &amp; sale terms</a>
